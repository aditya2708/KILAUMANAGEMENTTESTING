...
<ul class="horizontal-menu hidden border-t border-[#ebedf2] bg-white px-6 py-1.5 font-semibold text-black rtl:space-x-reverse dark:border-[#191e3a] dark:bg-[#0e1726] dark:text-white-dark lg:space-x-1.5 xl:space-x-8">
                            <li class="menu nav-item relative">
                                <a href="{{ url('berbagi-teknologi/dashboard') }}" class="nav-link {{ Request::segment(2) == 'dashboard' ? 'active' : '' }}">
                            ...
                            <li class="menu nav-item relative">
                                <a href="javascript:;" class="nav-link {{ Request::segment(2) == 'apps' ? 'active' : '' }}">
                                    <div class="flex items-center">
                                        <svg width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="shrink-0">
                                            <g opacity="0.5">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="{{ url('berbagi-teknologi/apps') }}" class="{{ Request::segment(2) == 'apps' ? 'active' : '' }}">List</a>
                                    </li>
                                    
                                    <li>
                                        <a href="{{ url('berbagi-teknologi/fitur') }}">Fitur</a>
                                    </li>
                                    
                                    <li>
                                        <a href="{{ url('berbagi-teknologi/price') }}">Price</a>
                                    </li>
                                </ul>
                            </li>
                            
                            <li class="menu nav-item relative">
                                <a href="{{ url('berbagi-teknologi/company') }}" class="nav-link {{ Request::segment(2) == 'company' ? 'active' : '' }}">
                                    <div class="flex items-center">
                                        <svg width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="shrink-0">
                            ...
                            <li class="menu nav-item relative">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="{{ url('berbagi-teknologi/level-company') }}">Company</a>
                                    </li>
                                    
                                    <li>
                                        <a href="{{ url('berbagi-teknologi/akses') }}">Akses</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('berbagi-teknologi/group') }}">Group</a>
                                    </li>
                                </ul>
                            </li>
                            
                            <li class="menu nav-item relative">
                                <a href="javascript:;" class="nav-link {{ Request::segment(2) == 'user-management' ? 'active' : '' }}">
                                    <div class="flex items-center">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="{{ url('berbagi-teknologi/user-management') }}" class="{{ Request::segment(2) == 'user-management' ? 'active' : '' }}">User Management</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <!--        </li>-->
                            <!--        <li>-->
                            <!--            <a href="pages-knowledge-base.html" class="active">Knowledge Base</a>-->
                            <!--        </li>-->
                            <!--        <li>-->
