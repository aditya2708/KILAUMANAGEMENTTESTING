@if(Auth::check())
<ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold" x-data="{ activeDropdown: 'pages' }">
                            ...
                            <div class="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                            ...
                            <li class="menu nav-item">
                                ...
                                <ul x-cloak="" x-show="activeDropdown === 'pages'" x-collapse="" class="sub-menu text-gray-500">
                                    <li>
                                        <a href="pages-knowledge-base.html" target="_blank">Knowledge Base</a>
                                    </li>
                                    <li>
                            ...
                            <li class="menu nav-item">
                                <a href="souysoeng.com" target="_blank" class="nav-link group">
                                    <div class="flex items-center">
                                        <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
