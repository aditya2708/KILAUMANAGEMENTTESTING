        ...
        <div class="modal fade" id="modal-default2">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Entry Pengajuan</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        </button>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <h3 style="margin-top: -10px">Informasi Pengajuan</h3>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    ...
                                                    <select class="js-example-basic-single wrap" name="jenis_t" id="jenis_t">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-xxs" data-bs-toggle="modal" data-bs-target="#modalb" href="#" style="float:right">Import</a>
                            <!--<a href="{{url('pengajuan-export/export')}}" class="btn btn-primary btn-xxs "  title="Ekspor">Ekspor</a>-->
                        <button type="submit" class="btn btn-primary btn-xxs" data-bs-toggle="tooltip" data-bs-placement="top" title="Ekspor Data">Export</button>
                            <button type="button" id="tambah" class="btn btn-success btn-xxs" data-bs-toggle="modal" data-bs-target="#modal-default1">Entri Pengajuan</button>
                            <!--<a href="{{url('pengajuan-anggaran/export')}}" class="btn btn-info btn-xxs" style="margin-right:15px" title="Ekspor">Ekspor</a>-->
                             <!--<button type="button" id="liaht" class="btn btn-success btn-xxs" data-bs-toggle="modal" data-bs-target="#modal-import">modal</button>-->
