...
<div class="content-body">
    ...
    <!--    </div>-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="js-example-basic-single saldd " name="saldo_dana" id="saldo_dana" style="width:100%">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                     <form method="GET" action="{{url('resume-anggaran/export')}}" >
                    <div class="card-header">
                        ...
                        <!--<button type="button" id="tambah" class="btn btn-success btn-xxs" data-bs-toggle="modal" data-bs-target="#modal-default1">Tambah</button>-->
                            ...
                            <!--<a href="{{url('resume-anggaran/export')}}" name="data1" value="data1" class= "btn btn-primary btn-xxs" style="float:right">Download </a>-->
                        <!--<a class="btn btn-primary btn-xxs" data-bs-toggle="modal" data-bs-target="#modalb" href="#" style="float:right">Import</a>-->
                        <div class="btn-group">
                                 <!--data-bs-toggle="dropdown" aria-expanded="false" -->
                                 <button type="button" class="btn btn-primary btn-sm dropdown-toggle " id="export" title="Export Data" data-bs-toggle="dropdown" aria-expanded="false">
                                    Ekspor
                                </button>
                        ...
                        <div class="basic-form">
                            ...
                            <div class="row">
                                <div class="col-lg-3 mb-3">
                                    <label >Periode :</label>
                                        <select class="form-control cekp " name="periode" id="periode">
                            ...
                            <!--</div>      -->
                                ...
                                <div class="col-lg-3 mb-3" id="tgl">
                                    <label>Range tanggal :</label>
                                    <input type="text" class="form-control  cekd" id="daterange" name="daterange" placeholder="{{ date('Y-m-d') }}">
                                </div>
                                <div class="col-lg-3 mb-3" id="bln" hidden>
                                    <label>Bulan :</label>
                                    <input type="text" class="form-control  cekd" id="month"  name="month" placeholder="{{ date('Y-m') }}">
                                </div>
                                <div class="col-lg-3 mb-3" id="thn" hidden>
                                    <label>Tahun :</label>
                                    <input type="text" class="form-control  cekd" id="years"  name="years" placeholder="{{ date('Y') }}">
                                </div>
